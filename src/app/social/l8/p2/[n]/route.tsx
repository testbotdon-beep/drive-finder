...
const slides = [
  { big: '5 things nobody tells you about finding a PDI in SG 🚗', sub: '', tag: '01', cover: true },
  { big: 'The good ones don\'t advertise.', sub: 'Their books have been full since 1992.', tag: '02' },
  { big: 'SG stopped issuing new PDI licences in 1987.', sub: 'The pool only shrinks from here.', tag: '03' },
  { big: 'Pass rate data is public info.', sub: 'No need to guess who\'s actually good.', tag: '04' },
  { big: 'Calling 20 numbers is a rite of passage', sub: 'nobody actually signs up for 🙃', tag: '05' },
  { big: 'Reddit rec threads are stale.', sub: 'Half those numbers are disconnected.', tag: '06' },
  { big: 'drivefindersg.uqlabs.co', sub: 'verifies availability before sending anyone your way', tag: '07', accent: true },
  { big: 'Save yourself the chaos 🙏', sub: 'Link in bio if stuck.', tag: '08', cta: true },
]
    ...
    (
      ...
      >
        ...
        >
          <div
            style={{
              fontSize: s.accent ? 72 : s.cover ? 84 : 74,
              fontWeight: 800,
